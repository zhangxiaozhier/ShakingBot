...
if __name__ == "__main__":
    train_data = TowelDataset(root_dir="/home/xss/zhangxiaozhi/VscodeProjects/shakingbot/network_training/data_studio_painted_bag/camera_3", phase='val', use_transform=True)
